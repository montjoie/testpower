...
do
	...
	cd acme-utils/pyacmecapture || exit $?
	ls
	cat lava-$y/0/tests/0_server/acme-utils/pyacmecapture/test_measurements-report.txt
	head -5 lava-$y/0/tests/0_server/acme-utils/pyacmecapture/test_measurements_Slot_8.csv
